...
;(function($){
	...
	// Smooth scrolling removed - using normal anchor links
	...
	// Preloader - removed overflow changes
	var $preload = $('#preloader');
	if ($preload.length > 0) {
		$(window).on('load', function() {
		  $preload.children().fadeOut(300);
		  $preload.delay(150).fadeOut(500);
		  // Removed overflow changes that were affecting scroll
		  // $('body').delay(100).css({
		  // 	'overflow': 'visible',
		  // 	'overflow-y': 'auto',
		  // 	'overflow-x': 'hidden'
