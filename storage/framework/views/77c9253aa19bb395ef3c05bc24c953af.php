				...
				<div class="container">
					...
					<div class="navbar-header">
						<a class="navbar-brand" href="<?php echo e(url('/')); ?>">
							<img class="logo logo-light" src="<?php echo e(asset('images/logo.png')); ?>" alt="logo" />
							<img class="logo logo-color" src="<?php echo e(asset('images/logo.png')); ?>" alt="logo" />
						</a>
					</div>
				</div><!-- /.container -->
			</nav>
				...
				<div class="row row-vm">
					<div class="col-md-7">
						<div class="header-texts tab-center mobile-center">
							...
							<ul class="buttons">
								<?php if($heroVariation && $heroVariation->yougarden_url): ?>
								<li><a href="<?php echo e($heroVariation->yougarden_url); ?>" class="button"><img src="<?php echo e(asset('images/yglogosmall.png')); ?>" alt="YouGarden" /></a></li>
								<?php else: ?>
								<li><a href="https://www.yougarden.com/item-p-100062/blooming-fast-superior-soluble-fertiliser" class="button"><img src="<?php echo e(asset('images/yglogosmall.png')); ?>" alt="YouGarden" /></a></li>
								<?php endif; ?>
								<?php if($heroVariation && $heroVariation->amazon_url): ?>
								<li><a href="<?php echo e($heroVariation->amazon_url); ?>" class="button"><img src="<?php echo e(asset('images/amazoncolour.png')); ?>" alt="Amazon" /></a></li>
								<?php else: ?>
								<li><a href="https://www.amazon.co.uk/s?k=<?php echo e(urlencode($product->name)); ?>" class="button"><img src="<?php echo e(asset('images/amazoncolour.png')); ?>" alt="Amazon" /></a></li>
								<?php endif; ?>
							</ul>
						</div>
					</div><!-- .col -->
					<div class="col-md-5" style="z-index: 999;">
						<div>
							<img style="z-index: 999;" src="<?php echo e(asset('images/superiorV4.png')); ?>" alt="<?php echo e($product->name); ?>" />
						</div>
					</div>
				</div><!-- .row -->
			</div><!-- .container -->
	...
	<div id="variations" class="variations-section section white-bg pt-0 pb-50">
		<div class="container">
			...
			<div class="variations-content pt-20">
				<div class="row">
					<?php $__currentLoopData = $allVariations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="col-md-4 col-sm-6 mb-30">
						<div class="variation-box text-center wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="<?php echo e(($index * 0.15)); ?>s">
							<div class="variation-inner" style="border: 2px solid #e0e0e0; border-radius: 12px; padding: 0; height: 100%; background: #fff; position: relative; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.1); transition: transform 0.3s ease, box-shadow 0.3s ease; display: flex; flex-direction: column;">
								<?php if($variation->is_bestseller): ?>
								...
								<div class="variation-image-wrapper" style="position: relative; background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 30px 20px 20px; margin-bottom: 0; flex-shrink: 0;">
									...
									<img src="<?php echo e($variation->image_url); ?>" alt="<?php echo e($variation->product->name); ?> - <?php echo e($variation->name); ?>" class="variation-product-image" style="width: 100%; max-width: 200px; height: auto; object-fit: contain; filter: drop-shadow(0 8px 20px rgba(0,0,0,0.15)); transition: transform 0.3s ease;" width="200" height="200" loading="lazy" />
									<?php else: ?>
									<img src="<?php echo e(asset('images/superiorV4.png')); ?>" alt="<?php echo e($variation->product->name); ?> - <?php echo e($variation->name); ?>" class="variation-product-image" style="width: 100%; max-width: 200px; height: auto; object-fit: contain; filter: drop-shadow(0 8px 20px rgba(0,0,0,0.15)); transition: transform 0.3s ease;" width="200" height="200" loading="lazy" />
									<?php endif; ?>
								</div>
								<!-- Product Details -->
								<div style="padding: 25px 20px 30px; flex-grow: 1; display: flex; flex-direction: column;">
									<h3 class="variation-name" style="font-size: 22px; margin-bottom: 8px; color: #333; margin-top: 0; font-weight: 600; min-height: 54px; display: flex; align-items: center; justify-content: center;">
										<a href="<?php echo e(route('product.show', $variation->slug)); ?>" style="color: #333; text-decoration: none; transition: color 0.3s ease;"><?php echo e($variation->product->name); ?></a>
									</h3>
									...
									<p class="variation-size" style="font-size: 16px; color: #666; margin-bottom: 15px; font-weight: 500; min-height: 24px;">
										<strong><?php echo e($variation->size); ?></strong>
									</p>
									<?php else: ?>
									...
									<p class="variation-price" style="font-size: 32px; color: #2ecc71; font-weight: bold; margin-bottom: 20px; line-height: 1; min-height: 38px;">
										£<?php echo e(number_format($variation->price, 2)); ?>

									</p>
									<?php else: ?>
									<div style="min-height: 38px; margin-bottom: 20px;"></div>
									<?php endif; ?>
									<div class="variation-buttons" style="margin-top: auto;">
										<?php if($variation->yougarden_url): ?>
										<a href="<?php echo e($variation->yougarden_url); ?>" target="_blank" rel="noopener noreferrer" class="button" style="display: inline-block; margin: 5px; padding: 10px 20px; background: #2ecc71; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px; transition: all 0.3s ease;">
											<img src="<?php echo e(asset('images/yglogosmall.png')); ?>" alt="Buy on YouGarden" style="height: 20px; vertical-align: middle;" />
										</a>
										<?php endif; ?>
										<?php if($variation->amazon_url): ?>
										<a href="<?php echo e($variation->amazon_url); ?>" target="_blank" rel="noopener noreferrer" class="button" style="display: inline-block; margin: 5px; padding: 10px 20px; background: #ff9900; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px; transition: all 0.3s ease;">
											<img src="<?php echo e(asset('images/amazoncolour.png')); ?>" alt="Buy on Amazon" style="height: 20px; vertical-align: middle;" />
										</a>
										<?php else: ?>
										<a href="https://www.amazon.co.uk/s?k=<?php echo e(urlencode($variation->product->name . ' ' . $variation->name)); ?>" target="_blank" rel="noopener noreferrer" class="button" style="display: inline-block; margin: 5px; padding: 10px 20px; background: #ff9900; color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px; transition: all 0.3s ease;">
											<img src="<?php echo e(asset('images/amazoncolour.png')); ?>" alt="Buy on Amazon" style="height: 20px; vertical-align: middle;" />
										</a>
										<?php endif; ?>
									</div>
	...
	<div id="about" class="about-section section pb-50 white-bg half-header-about">
		<div class="container tab-fix">
			...
			<div class="row tab-center mobile-center">
				<div class="col-md-6">
					<div class="video">
						<img src="<?php echo e(asset('images/video.png')); ?>" alt="Superior Plant Food Video - How to Use Professional Grade Fertilizer" width="600" height="400" loading="lazy" />
				...
				<div class="row">
					...
					<div class="col-md-6 text-center push-left">
						<div class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
							<img src="<?php echo e(asset('images/superiorback.png')); ?>" alt="Superior Plant Food Ingredients - NPK 18:18:24 with Trace Elements" width="500" height="500" loading="lazy" />
						</div>
					</div><!-- .col -->
				</div><!-- .row -->
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 mb-40 wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.1s">
					<div class="footer-logo">
						<img src="<?php echo e(asset('images/logo.png')); ?>" alt="Blooming Fast - Superior Plant Food Logo" width="200" height="80" class="footer-logo-img" loading="lazy" />
					</div>
				...
				<div class="col-md-2 col-sm-6 mb-40 wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.2s">
					...
					<ul class="footer-links-list" style="list-style: none; padding: 0;">
						...
						<li style="margin-bottom: 12px;"><a href="<?php echo e(route('products.index')); ?>" class="footer-link" style="color: rgba(255,255,255,0.8); text-decoration: none;">All Products</a></li>
					</ul>
				</div>
				...
				<div class="col-md-3 col-sm-6 mb-40 wow fadeInUp" data-wow-duration="0.6s" data-wow-delay="0.3s">
					...
					<ul class="footer-links-list" style="list-style: none; padding: 0;">
						...
						<li style="margin-bottom: 12px;"><a href="<?php echo e(route('products.index')); ?>" class="footer-link" style="color: rgba(255,255,255,0.8); text-decoration: none; transition: all 0.3s;">
				...
				<div class="row">
					<div class="col-md-6">
						<p style="color: rgba(255,255,255,0.8); margin: 0; font-size: 14px;">
							Copyright © <?php echo e(date('Y')); ?> Blooming Fast. All rights reserved.
						</p>
					</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/tom/Herd/bloom/resources/views/home.blade.php ENDPATH**/ ?>