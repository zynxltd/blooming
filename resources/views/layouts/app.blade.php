...
<head>
	...
	<meta name="description" content="@yield('meta_description', 'Blooming Fast Superior Plant Food - Professional grade NPK 18:18:24 fertilizer. Available in 7 sizes. Trusted by 50,000+ gardeners. Fast-acting results in 7-14 days. Buy on YouGarden and Amazon.')">
	...
	<meta property="og:title" content="@yield('title', 'Blooming Fast Superior Plant Food - Professional Grade Fertilizer')">
	<meta property="og:description" content="@yield('meta_description', 'Trusted by 50,000+ gardeners. Available in 7 sizes. Fast-acting results in 7-14 days.')">
	<meta property="og:type" content="website">
	<meta property="og:url" content="{{ url()->current() }}">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:title" content="@yield('title', 'Blooming Fast Superior Plant Food')">
	<meta name="twitter:description" content="@yield('meta_description', 'Professional grade NPK 18:18:24 fertilizer. Available in 7 sizes.')">
	<!-- Fav Icon  -->
	<link rel="shortcut icon" href="{{ asset('images/favicon.png') }}">
	<!-- Site Title  -->
	<title>@yield('title', 'Blooming Fast Superior Plant Food - Professional Grade Fertilizer | Available in 7 Sizes')</title>
	...
	<style>
		...
		* {
		...
		/* Hero buttons - consistent with product card buttons */
		.hero-btn {
			position: relative !important;
		...
		/* YouGarden button specific */
		.hero-btn[href*="yougarden"] {
			background: #2ecc71 !important;
			color: #fff !important;
		}
		.hero-btn[href*="yougarden"]:hover {
			background: #27ae60 !important;
		}
		/* Amazon button specific */
		.hero-btn[href*="amazon"] {
			background: #ff9900 !important;
			color: #fff !important;
		}
		.hero-btn[href*="amazon"]:hover {
		...
		.header-curbed::after {
			...
			height: 100% !important;
			width: 100% !important;
			background: url({{ asset('images/carb.png') }}) bottom no-repeat !important;
...
<body>
	...
	<div id="preloader">
		<div id="status">
			<img src="{{ asset('images/logo.png') }}" alt="Blooming Fast" style="max-width: 200px; height: auto; animation: pulse 2s ease-in-out infinite;" />
		</div>
	</div> 
	<!-- Preloader End -->
